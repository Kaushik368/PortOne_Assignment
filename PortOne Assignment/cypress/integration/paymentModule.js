...
//TC-008
    //To validate the functionality of the Payment Details Form on the Payment details page with Invalid data.
    it('TC008', () => {
        
        cy.xpath("//div[@id='mySelect']").click();
        cy.contains("English").click();
        cy.get("#amount").click().type("15000");
        cy.xpath("//input[@id='2R5s8kRxgWmnOa62FsVfHa7mQog']").click().type(Name);
        cy.xpath("//input[@id='2R5s8gTLnMViCb1izrbpOb6LpQJ']").click().type("kaubis368gmail.com");
        ...
        cy.get(".css-vifbhv").screenshot({ capture:"fullPage",padding:60 });
        cy.xpath("//button[@type='button']").should('be.disabled');
        cy.wait(3000);
    });
...
//TC-012
        ...
        cy.get("#defaultAddressName").should("have.text",Name).screenshot({ capture:"fullPage",padding:50 });
...
//TC-019
        ...
        cy.get("#card_name").click().type(Name);
